 ...
 *
 * Demonstrates:
 *  - Test fixtures  : shared objects prepared in @Before
 *  - @BeforeClass   : one-time setup before ALL tests in the class
 *  - @Before        : setup before EACH test
 *  - @After         : teardown after EACH test
 *  - @AfterClass    : one-time cleanup after ALL tests in the class
 *  - Full AAA pattern inside every @Test method
 */
public class BankAccountTest {
    ...
    /** AAA: account holder name is stored correctly */
    @Test
